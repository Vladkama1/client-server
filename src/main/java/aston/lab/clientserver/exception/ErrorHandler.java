...
public class ErrorHandler {
    ...
    public ResponseError handleDataIntegrityViolationException(final DataIntegrityViolationException e) {
        log.error("Exception DataIntegrityViolationException: {}, статус ответа: {}", e.getMessage(), HttpStatus.CONFLICT);
